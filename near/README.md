...
near deploy bitcoin_connector.testnet --wasm-file "./target/wasm32-unknown-unknown/release/bitcoin_connector.wasm" --init-function "new" --init-args '{"omni_btc": "omni_btc.testnet", "confirmations": 2, "btc_light_client": "btc-client-v4.testnet"}'
```
